...
# %%
print(
    cattle_inventory.loc[
        cattle_inventory.year == 1997, "cattle_cow_beef_inventory"
    ].sum()
)
print(
    cattle_inventory.loc[
        cattle_inventory.year == 2017, "cattle_cow_beef_inventory"
    ].sum()
)

# %%
invent_commonCnty = cattle_inventory[
    cattle_inventory.county_fips.isin(list(common_counties))
].copy()
...
# %%
invent_commonCnty_Pallavi = invent_commonCnty[
    invent_commonCnty.county_fips.isin(RA.county_fips.unique())
]
...
# %%
invent_commonCnty_1997_2017 = pd.merge(
    invent_commonCnty_1997[["county_fips", "inven_1997"]],
...
invent_commonCnty_1997_2017["inven_1997_share"] = (
    invent_commonCnty_1997_2017["inven_1997"] / invent_commonCnty_1997_total
)

invent_commonCnty_1997_2017["inven_2017_share"] = (
    invent_commonCnty_1997_2017["inven_2017"] / invent_commonCnty_2017_total
)

invent_commonCnty_1997_2017["share_change_1997_2017"] = (
    invent_commonCnty_1997_2017["inven_2017_share"]
    - invent_commonCnty_1997_2017["inven_1997_share"]
)
invent_commonCnty_1997_2017.head(2)
...
inventory_1997_2017 = pd.merge(
    inventory_1997[["county_fips", "inven_1997"]],
...
# %%
inventory_1997_2017["inven_1997_share"] = (
    inventory_1997_2017["inven_1997"] / inventory_1997_total
)

inventory_1997_2017["inven_2017_share"] = (
    inventory_1997_2017["inven_2017"] / inventory_2017_total
)

inventory_1997_2017["share_change_1997_2017"] = (
    inventory_1997_2017["inven_2017_share"]
    - invent_commonCnty_1997_2017["inven_1997_share"]
)
inventory_1997_2017.head(2)
...
while census_years:
    ...
    for yr in census_years:
        cattle_inventory_smYr = cattle_inventory[
            cattle_inventory.year == small_yr
        ].copy()
        ...
        cattle_inventory_smYr = cattle_inventory_smYr[
            cattle_inventory_smYr.county_fips.isin(common_cnty)
        ]
        cattle_inventory_Yr = cattle_inventory_Yr[
            cattle_inventory_Yr.county_fips.isin(common_cnty)
        ]

        invent_smYr_Yr = pd.merge(
            cattle_inventory_smYr[["county_fips", n_smallYr]],
...
# %%
out_name = (
    data_dir_base + "data_4_plot/" + "inventory_AbsChange_4panel_commonCounties.csv"
)
...
while census_years:
    ...
    for yr in census_years:
        ...
        inventory_smYr[n_smallYr_shareCol] = 100 * (
            inventory_smYr[n_smallYr] / inven_smYr_total
        )
...
for yr in census_years:
    ...
    inventory_smYr.rename(columns={inv_col: smallYr_inv_NewcolName}, inplace=True)
...
# %%
out_name = (
    data_dir_base + "data_4_plot/" + "inventory_ShareChange_4panel_commonCounties.csv"
)
all_df_.to_csv(out_name, index=False)
