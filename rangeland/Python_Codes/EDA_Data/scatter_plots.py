...
# %%
X = df_OuterJoined[["inventory", "rangeland_acre", "herb_avg", 
                    "herb_area_acr", "total_matt_npp", "irr_hay_area"]]
...
# %%
X = df_OuterJoined[["total_matt_npp", "dangerEncy", "yr_cntymean_precip", "annual_avg_tavg"]]
