...
# %% [markdown]
# This notebook is created on Oct 24. But the name includes Oct. 17 
...
ML_data_dir = "/Users/hn/Documents/01_research_data/NASA/ML_data_Oct17/"
...
# %%
GT_labels=GT_labels[GT_labels.ID.isin(list(meta.ID.unique()))].copy()
GT_labels.shape
...
# %%
trainIDs = list(GT_labels.ID.unique())
...
# %%
plot_dir_base = "/Users/hn/Documents/01_research_data/NASA/ML_data_Oct17/"
plot_path = plot_dir_base + "SG_groundTruth_images_" + VI_idx + "/"
...
for curr_ID in data.ID.unique():
    ...
    crop_count = GT_labels[GT_labels.ID==curr_ID]["Vote"].values[0]
    if crop_count==1:
...
for curr_ID in sample_IDs:
    ...
    fig_name = plot_path + crop_count_letter + "_" + curr_ID +'.png'
    plt.savefig(fname = fig_name, dpi=400, bbox_inches='tight', facecolor="w")
...
# %%
plot_dir_base = "/Users/hn/Documents/01_research_data/NASA/ML_data_Oct17/"
plot_path = plot_dir_base + "regular_groundTruth_images_" + VI_idx + "/"
os.makedirs(plot_path, exist_ok=True)
