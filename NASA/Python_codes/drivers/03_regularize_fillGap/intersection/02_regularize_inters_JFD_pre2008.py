...
f_name = "NoJump_intersect_" + indeks + "_batchNumber" + str(batch) + "_JFD_pre2008.csv"
out_name = output_dir + indeks + "_regular_intersect_batchNumber" + batch + "_JFD_pre2008.csv"
