  ...
  do
    ...
    do
      ...
      do
        ...
        do
          cp temp_apply_3Models_DeskReject.sh ./qsubs/apply_$indeks$smooth$ML_model$trainID$SR.sh
          ...
          sed -i s/ML_model/"$ML_model"/g     ./qsubs/apply_$indeks$smooth$ML_model$trainID$SR.sh
  ...
  do
    ...
    do
      ...
      do
        for SR in 3 4 5 6 7 8
        do
          cp temp_apply_3Models_DeskReject_KNN.sh ./qsubs/apply_$indeks$smooth$ML_model$trainID$SR.sh
          sed -i s/indeks/"$indeks"/g         ./qsubs/apply_$indeks$smooth$ML_model$trainID$SR.sh
          sed -i s/smooth/"$smooth"/g         ./qsubs/apply_$indeks$smooth$ML_model$trainID$SR.sh
          sed -i s/ML_model/"$ML_model"/g     ./qsubs/apply_$indeks$smooth$ML_model$trainID$SR.sh
          sed -i s/trainID/"$trainID"/g       ./qsubs/apply_$indeks$smooth$ML_model$trainID$SR.sh
