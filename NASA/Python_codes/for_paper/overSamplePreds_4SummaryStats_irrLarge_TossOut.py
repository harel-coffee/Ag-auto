...
# %%
NDVI_SG_summary_count = pd.DataFrame(columns=list(NDVI_SG_preds.columns[1:5]))

NDVI_SG_summary_count[NDVI_SG_summary_count.columns[0]] = \
             NDVI_SG_preds.groupby([NDVI_SG_summary_count.columns[0], "county"])['ID'].count()

NDVI_SG_summary_count[NDVI_SG_summary_count.columns[1]] = \
             NDVI_SG_preds.groupby([NDVI_SG_summary_count.columns[1], "county"])['ID'].count()
    
NDVI_SG_summary_count[NDVI_SG_summary_count.columns[2]] = \
             NDVI_SG_preds.groupby([NDVI_SG_summary_count.columns[2], "county"])['ID'].count()
    
NDVI_SG_summary_count[NDVI_SG_summary_count.columns[3]] = \
             NDVI_SG_preds.groupby([NDVI_SG_summary_count.columns[3], "county"])['ID'].count()
# NDVI_SG_summary_count.reset_index(drop=False, inplace=True, col_fill='', names="predictedabel")

out_name = pred_dir_base + "NDVI_SG_summary_count_overSample.csv"
# NDVI_SG_summary_count.to_csv(out_name, index = False)
NDVI_SG_summary_count.index.rename(['label', 'county'], inplace=True)
NDVI_SG_summary_count.round()
...
df.reset_index(inplace=True) 
df=df[df.label==2]
df.iloc[:, 1:].plot.bar(x='county', ylabel="acreage",
                        stacked=True, rot=0, grid=0);


# %%
NDVI_regular_summary_count = pd.DataFrame(columns=list(NDVI_regular_preds.columns[1:5]))

NDVI_regular_summary_count[NDVI_regular_summary_count.columns[0]] = \
             NDVI_regular_preds.groupby([NDVI_regular_summary_count.columns[0], "county"])['ID'].count()

NDVI_regular_summary_count[NDVI_regular_summary_count.columns[1]] = \
             NDVI_regular_preds.groupby([NDVI_regular_summary_count.columns[1], "county"])['ID'].count()
    
NDVI_regular_summary_count[NDVI_regular_summary_count.columns[2]] = \
             NDVI_regular_preds.groupby([NDVI_regular_summary_count.columns[2], "county"])['ID'].count()
    
NDVI_regular_summary_count[NDVI_regular_summary_count.columns[3]] = \
             NDVI_regular_preds.groupby([NDVI_regular_summary_count.columns[3], "county"])['ID'].count()
# NDVI_regular_summary_count.reset_index(drop=False, inplace=True, col_fill='', names="predictedabel")

out_name = pred_dir_base + "NDVI_regular_summary_count_overSample.csv"
# NDVI_regular_summary_count.to_csv(out_name, index = False)
NDVI_regular_summary_count.index.rename(['label', 'county'], inplace=True)
NDVI_regular_summary_count.round()

# %%
df = NDVI_regular_summary_count.copy()
df.reset_index(inplace=True)
df = df[df.label==2]
################################################################
fig, axs = plt.subplots(1, 1, figsize=(7, 3), sharex=False, # sharey='col', # sharex=True, sharey=True,
...
# %%
EVI_SG_summary_count = pd.DataFrame(columns=list(EVI_SG_preds.columns[1:5]))

EVI_SG_summary_count[EVI_SG_summary_count.columns[0]] = \
             EVI_SG_preds.groupby([EVI_SG_summary_count.columns[0], "county"])['ID'].count()

EVI_SG_summary_count[EVI_SG_summary_count.columns[1]] = \
             EVI_SG_preds.groupby([EVI_SG_summary_count.columns[1], "county"])['ID'].count()
    
EVI_SG_summary_count[EVI_SG_summary_count.columns[2]] = \
             EVI_SG_preds.groupby([EVI_SG_summary_count.columns[2], "county"])['ID'].count()
    
EVI_SG_summary_count[EVI_SG_summary_count.columns[3]] = \
             EVI_SG_preds.groupby([EVI_SG_summary_count.columns[3], "county"])['ID'].count()
# EVI_SG_summary_count.reset_index(drop=False, inplace=True, col_fill='', names="predictedabel")

out_name = pred_dir_base + "EVI_SG_summary_count_overSample.csv"
# EVI_SG_summary_count.to_csv(out_name, index = False)
EVI_SG_summary_count.index.rename(['label', 'county'], inplace=True)
EVI_SG_summary_count.round()

# %%
df = EVI_SG_summary_count.copy()
df.reset_index(inplace=True)
df = df[df.label==2]
################################################################
fig, axs = plt.subplots(1, 1, figsize=(7, 3), sharex=False, # sharey='col', # sharex=True, sharey=True,
...
# %%
EVI_regular_summary_count = pd.DataFrame(columns=list(EVI_regular_preds.columns[1:5]))

EVI_regular_summary_count[EVI_regular_summary_count.columns[0]] = \
             EVI_regular_preds.groupby([EVI_regular_summary_count.columns[0], "county"])['ID'].count()

EVI_regular_summary_count[EVI_regular_summary_count.columns[1]] = \
             EVI_regular_preds.groupby([EVI_regular_summary_count.columns[1], "county"])['ID'].count()
    
EVI_regular_summary_count[EVI_regular_summary_count.columns[2]] = \
             EVI_regular_preds.groupby([EVI_regular_summary_count.columns[2], "county"])['ID'].count()
    
EVI_regular_summary_count[EVI_regular_summary_count.columns[3]] = \
             EVI_regular_preds.groupby([EVI_regular_summary_count.columns[3], "county"])['ID'].count()
# EVI_regular_summary_count.reset_index(drop=False, inplace=True, col_fill='', names="predictedabel")

out_name = pred_dir_base + "EVI_regular_summary_count_overSample.csv"
# EVI_regular_summary_count.to_csv(out_name, index = False)
EVI_regular_summary_count.index.rename(['label', 'county'], inplace=True)
EVI_regular_summary_count.round()

# %%
df = EVI_regular_summary_count.copy()
df.reset_index(inplace=True)
df = df[df.label==2]
################################################################
fig, axs = plt.subplots(1, 1, figsize=(7, 3), sharex=False, # sharey='col', # sharex=True, sharey=True,
...
EVI_SG_preds = EVI_SG_preds.copy()
...
# %%
SF_data_LSD_grp_area = SF_data_LSD.groupby(['CropTyp'])['ExctAcr'].sum()
SF_data_LSD_grp_area = pd.DataFrame(SF_data_LSD_grp_area)
SF_data_LSD_grp_area.reset_index(drop=False, inplace=True)
...
col1 = group_sum_area(NDVI_SG_preds_LSD, [NDVI_SG_preds_LSD.columns[1], "CropTyp"])
col2 = group_sum_area(NDVI_SG_preds_LSD, [NDVI_SG_preds_LSD.columns[2], "CropTyp"])
col3 = group_sum_area(NDVI_SG_preds_LSD, [NDVI_SG_preds_LSD.columns[3], "CropTyp"])
col4 = group_sum_area(NDVI_SG_preds_LSD, [NDVI_SG_preds_LSD.columns[4], "CropTyp"])
...
NDVI_SG_crop_summary_LSD = pd.merge(
    NDVI_SG_crop_summary_LSD, SF_data_LSD_grp_area, on=(["CropTyp"]), how="left"
)
...
# %%
print (f"{NDVI_SG_crop_summary_LSD.SVM_NDVI_SG_preds.max()=}")
print (f"{NDVI_SG_crop_summary_LSD.SVM_NDVI_SG_preds.idxmax()=}")
print ("")
print (NDVI_SG_crop_summary_LSD.iloc[NDVI_SG_crop_summary_LSD.SVM_NDVI_SG_preds.idxmax()])

# %%
EVI_SG_crop_summary_LSD = pd.DataFrame(columns=["label", "CropTyp"])
EVI_SG_preds_LDS = EVI_SG_preds[EVI_SG_preds.ID.isin(list(SF_data_LSD.ID))]


col1 = group_sum_area(EVI_SG_preds_LDS, [EVI_SG_preds_LDS.columns[1], "CropTyp"])
col2 = group_sum_area(EVI_SG_preds_LDS, [EVI_SG_preds_LDS.columns[2], "CropTyp"])
col3 = group_sum_area(EVI_SG_preds_LDS, [EVI_SG_preds_LDS.columns[3], "CropTyp"])
col4 = group_sum_area(EVI_SG_preds_LDS, [EVI_SG_preds_LDS.columns[4], "CropTyp"])
...
EVI_SG_crop_summary_LSD = pd.merge(
    EVI_SG_crop_summary_LSD, SF_data_LSD_grp_area, on=(["CropTyp"]), how="left"
)
...
NDVI_regular_preds_LDS = NDVI_regular_preds[NDVI_regular_preds.ID.isin(list(SF_data_LSD.ID))]

col1 = group_sum_area(NDVI_regular_preds_LDS, [NDVI_regular_preds_LDS.columns[1], "CropTyp"])
col2 = group_sum_area(NDVI_regular_preds_LDS, [NDVI_regular_preds_LDS.columns[2], "CropTyp"])
col3 = group_sum_area(NDVI_regular_preds_LDS, [NDVI_regular_preds_LDS.columns[3], "CropTyp"])
col4 = group_sum_area(NDVI_regular_preds_LDS, [NDVI_regular_preds_LDS.columns[4], "CropTyp"])
...
NDVI_regular_crop_summary_LSD = pd.merge(
    NDVI_regular_crop_summary_LSD, SF_data_LSD_grp_area, on=(["CropTyp"]), how="left"
)
...
EVI_regular_preds_LDS = EVI_regular_preds[EVI_regular_preds.ID.isin(list(SF_data_LSD.ID))]

col1 = group_sum_area(EVI_regular_preds_LDS, [EVI_regular_preds_LDS.columns[1], "CropTyp"])
col2 = group_sum_area(EVI_regular_preds_LDS, [EVI_regular_preds_LDS.columns[2], "CropTyp"])
col3 = group_sum_area(EVI_regular_preds_LDS, [EVI_regular_preds_LDS.columns[3], "CropTyp"])
col4 = group_sum_area(EVI_regular_preds_LDS, [EVI_regular_preds_LDS.columns[4], "CropTyp"])
...
EVI_regular_crop_summary_LSD = pd.merge(
    EVI_regular_crop_summary_LSD, SF_data_LSD_grp_area, on=(["CropTyp"]), how="left"
)
...
file_name = plot_dir + "NDVI_SG_cropWise_AcreagePrecent.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "EVI_SG_cropWise_AcreagePrecent.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "EVI_regular_cropWise_AcreagePrecent.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "NDVI_regular_cropWise_AcreagePrecent.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
