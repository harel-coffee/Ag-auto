...
plot_dir = dir_base + "for_paper/plots/overSampleRegionalStats/alfa_and_2Potentials_NumDenom/"
...
# %%
print (f"{len(nc.filter_out_nonIrrigated(SF_data).CropTyp.unique())=}")
print (f"{len(nc.filter_out_nonIrrigated(SF_data).Irrigtn.unique())=}")
...
#EVI_SG_county_acr_summary.reset_index(drop=False, inplace=True, col_fill='', names="predicted_label")
#out_name = pred_dir_base + "EVI_SG_county_acr_summary_overSample.csv"
#EVI_SG_county_acr_summary.to_csv(out_name, index = False)
...
#NDVI_SG_county_acr_summary.reset_index(drop=False, inplace=True, col_fill='', names="predicted_label")
# out_name = pred_dir_base + "NDVI_SG_county_acr_summary_overSample.csv"
# NDVI_SG_county_acr_summary.to_csv(out_name, index = False)
...
# NDVI_reg_county_acr_summary.reset_index(drop=False, inplace=True, col_fill='', names="predicted_label")
# out_name = pred_dir_base + "NDVI_regularular_summary_overSample.csv"
# NDVI_reg_county_acr_summary.to_csv(out_name, index = False)
