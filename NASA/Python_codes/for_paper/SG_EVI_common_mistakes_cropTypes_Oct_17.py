...
SVM_winner = pickle.load(open(filename, 'rb'))
...
SVM_winner_preds = SVM_winner.predict(x_test_df.iloc[:, 1:])
...
# %%
SVM_winner_y_test_df=y_test_df.copy()
SVM_winner_y_test_df["prediction"] = list(SVM_winner_preds)
SVM_winner_y_test_df.head(2)
...
# %%
out_name=test_result_dir+ "SG_SVM_NoneWeight_winner_test_"+VI_idx+".csv"
SVM_winner_y_test_df.to_csv(out_name, index = False)
...
SVM_winner_y_test_df = pd.merge(SVM_winner_y_test_df, meta, on=['ID'], how='left')

# %%

# %%
SVM_winner_y_test_df_A2_P1 = SVM_winner_y_test_df[SVM_winner_y_test_df.Vote==2]
SVM_winner_y_test_df_A2_P1 = SVM_winner_y_test_df_A2_P1[SVM_winner_y_test_df_A2_P1.prediction==1]

SVM_winner_y_test_df_A1_P2 = SVM_winner_y_test_df[SVM_winner_y_test_df.Vote==1]
SVM_winner_y_test_df_A1_P2 = SVM_winner_y_test_df_A1_P2[SVM_winner_y_test_df_A1_P2.prediction==2]

# %%

# %%
sorted(SVM_winner_y_test_df_A1_P2.CropTyp)

# %%
SVM_winner_y_test_df_A1_P2

# %%
SVM_winner_y_test_df_A2_P1
...
# %%
for anID in list(SVM_winner_y_test_df_A1_P2.ID):
    ...
    curr_vote = SVM_winner_y_test_df_A1_P2[SVM_winner_y_test_df_A1_P2.ID==anID].Vote.values[0]
    curr_pred = SVM_winner_y_test_df_A1_P2[SVM_winner_y_test_df_A1_P2.ID==anID].prediction.values[0]
    ...
    plot_path = test_result_dir + "SG_SVM_noneWeight_winner_test_plots_A1_P2/"
    os.makedirs(plot_path, exist_ok=True)
    fig_name = plot_path + anID + '.pdf'
    plt.savefig(fname = fig_name, dpi=400, bbox_inches='tight')
    plt.close('all')

for anID in list(SVM_winner_y_test_df_A2_P1.ID):
    curr_dt = ground_truth[ground_truth.ID==anID].copy()
    curr_meta = meta[meta.ID==anID].copy()
    ...
    curr_vote = SVM_winner_y_test_df_A2_P1[SVM_winner_y_test_df_A2_P1.ID==anID].Vote.values[0]
    curr_pred = SVM_winner_y_test_df_A2_P1[SVM_winner_y_test_df_A2_P1.ID==anID].prediction.values[0]
    title_ = list(curr_meta.CropTyp)[0] + " (" + str(list(curr_meta.Acres)[0]) + " acre), "+\
             "Experts' vote: " + str(curr_vote) + ", prediction: " + str(curr_pred)
    ...
    plot_path = test_result_dir + "SG_SVM_noneWeight_winner_test_plots_A2_P1/"
    os.makedirs(plot_path, exist_ok=True)
    fig_name = plot_path + anID + '.pdf'
    plt.savefig(fname = fig_name, dpi=400, bbox_inches='tight')
    plt.close('all')
...
# %%
filename = model_dir + 'SG_EVI_RF_grid_1_Oct17_accuracyScoring.sav'
...
# %% [markdown]
# # kNN
# Winner is **uniform** weight. AUC won over accuracy due to better double detection.
...
# %%
filename = model_dir + "00_KNN_SG_EVI_DTW_prune_distanceWeight_18NNisBest_AUCScoring.sav"
...
# %%
out_name=test_result_dir+ "SG_KNN_EVI_y_test.csv"
KNN_y_test.to_csv(out_name, index = False)

# %%
for anID in list(KNN_y_test_dist_A1P2.ID):
    curr_dt = ground_truth[ground_truth.ID==anID].copy()
    curr_meta = meta[meta.ID==anID].copy()
    ...
    curr_vote = KNN_y_test_dist_A1P2[KNN_y_test_dist_A1P2.ID==anID].Vote.values[0]
    curr_pred = KNN_y_test_dist_A1P2[KNN_y_test_dist_A1P2.ID==anID].KNN_pred_distance.values[0]
    title_ = list(curr_meta.CropTyp)[0] + " (" + str(list(curr_meta.Acres)[0]) + " acre), "+\
              "Experts' vote: " + str(curr_vote) + ", prediction: " + str(curr_pred)
    
    curr_plt = plot_oneColumn_CropTitle(dt=curr_dt, raw_dt=curr_raw, titlee=title_, _label = "EVI (5-step smoothed)")
    
    plot_path = test_result_dir + "SG_EVI_KNN_plots_A1_P2/"
    os.makedirs(plot_path, exist_ok=True)
    fig_name = plot_path + anID + '.pdf'
    plt.savefig(fname = fig_name, dpi=400, bbox_inches='tight')
    plt.close('all')
    
for anID in list(KNN_y_test_dist_A2P1.ID):
    curr_dt = ground_truth[ground_truth.ID==anID].copy()
    curr_meta = meta[meta.ID==anID].copy()
    ...
    curr_vote = KNN_y_test_dist_A2P1[KNN_y_test_dist_A2P1.ID==anID].Vote.values[0]
    curr_pred = KNN_y_test_dist_A2P1[KNN_y_test_dist_A2P1.ID==anID].KNN_pred_distance.values[0]
    title_ = list(curr_meta.CropTyp)[0] + " (" + str(list(curr_meta.Acres)[0]) + " acre), "+\
              "Experts' vote: " + str(curr_vote) + ", prediction: " + str(curr_pred)
    
    curr_plt = plot_oneColumn_CropTitle(dt=curr_dt, raw_dt=curr_raw, titlee=title_, _label = "EVI (5-step smoothed)")
    
    plot_path = test_result_dir + "SG_EVI_KNN_plots_A2_P1/"
    os.makedirs(plot_path, exist_ok=True)
    fig_name = plot_path + anID + '.pdf'
    plt.savefig(fname = fig_name, dpi=400, bbox_inches='tight')
    plt.close('all')
...
# %%
print (KNN_y_test_dist_A2P1.groupby(['CropTyp'])['CropTyp'].count())
print ("------------------------------------------------------------------------")
print (KNN_y_test_dist_A1P2.groupby(['CropTyp'])['CropTyp'].count())
...
# %%
SVM_winner_y_test_df_A2_P1.rename(columns={"prediction": "SVM_winner_pred_A2P1"}, inplace=True)
SVM_winner_y_test_df_A1_P2.rename(columns={"prediction": "SVM_winner_pred_A1P2"}, inplace=True)
...
# %%
vote_columns =['SVM_winner_pred_A2P1', 'SVM_winner_pred_A1P2',
