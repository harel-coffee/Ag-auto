...
#
# This is a copy of ```overSamplePreds_4SummaryStat_2PotensNumerator_AllirrDenom.ipynb```.
# In that notebook 2Crop Potentials are in numerator and alfalfa is out.
# Here alfalfa will be in numerator too.
#
#
...
plot_dir = dir_base + "/for_paper/plots/overSampleRegionalStats/AllirrDenom/alfa_and_2PotensNumerator/"
...
file_name = plot_dir + "EVI_regular_acreagePerc_countyWise_Alfapotens_AllIrrDenom.pdf"
...
file_name = plot_dir + "EVI_SG_acreagePerc_countyWise_Alfapotens_AllIrrDenom.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "NDVI_regular_acreagePerc_countyWise_Alfapotens_AllIrrDenom.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "NDVI_SG_acreagePerc_countyWise_Alfapotens_AllIrrDenom.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "EVI_regular_countPerc_countyWise_Alfapotens_AllIrrDenom.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "EVI_SG_countPerc_countyWise_Alfapotens_AllIrrDenom.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "NDVI_SG_countPerc_countyWise_Alfapotens_AllIrrDenom.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
...
file_name = plot_dir + "NDVI_regular_countPerc_countyWise_Alfapotens_AllIrrDenom.pdf"
plt.savefig(fname = file_name, dpi=400, bbox_inches='tight', transparent=False);
